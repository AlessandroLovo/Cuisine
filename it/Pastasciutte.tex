...
\begin{document}
    ...
    \begin{recipe}
        [%
            preparationtime = {\unit[40]{min}},
            portion = {\unit[8]{Porzioni}},
            source = {Alghero 02/08/2023},
        ]
        {Ragù vegano}
        ...
        \ingredients{
            \unit[250]{g} & Soia disidratata \\
            2 & Cipolle \\
            2 & Carote \\
            \unit[3]{cucchiai} & Olio EVO \\
            \unit[50]{ml} & Salsa di soia \\
            \unit[1/2]{l} & Acqua \\
            1 & Peperoncino \\
            \unit[1]{cucchiaino} & Sale \\
            \unit[2]{cucchiaini} & Zucchero \\
            \unit[700]{g} & Passata di pomodoro \\
            \unit[1]{mazzetto} & Prezzemolo fresco \\
            \unit[1]{rametto} & Rosmarino fresco \\
        ...
        \preparation{
            \begin{enumerate}
            \item Mondate le cipolle e tagliatele a pezzi di media grandezza. Mettete a soffriggere in una pentola o un wok con l'olio.
            \item Lavate il prezzemolo e aggiungete le foglie al soffritto.
            \item Pelate e tagliate la carota a pezzettini piccoli. Aggiungete al soffritto insieme alle bacche di ginepro, i chiodi di garofano e il peperoncino.
            \item Aggiungete la soia disidratata, fate saltare per un minuto, poi aggiungete la salsa di soia. Mescolate in modo che sia ben assorbita.
            \item Aggiungete gradualmente l'acqua per idratare la soia. Mantenete il fuoco medio-alto in modo che sobbolisca.
            \item Aggiungete la passata di pomodoro, il rosmarino, il sale e lo zucchero. Mescolate per bene e lasciate cuocere a fuoco medio con il coperchio chiuso per circa mezz'ora. A metà cottura assaggiate e eventualmente aggiustate con sale, zucchero, salsa di soia, peperoncino o rosmarino.
            \item Al termine della mezz'ora togliete il coperchio e fate restringere il sugo a piacimento.
            \end{enumerate}
        }
    \end{recipe}
